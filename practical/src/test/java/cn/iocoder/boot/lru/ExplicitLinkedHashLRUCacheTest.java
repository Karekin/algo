...
class ExplicitLinkedHashLRUCacheTest {

    @Test
    void testCacheBasicOperations() {
        ExplicitLinkedHashLRUCache cache = new ExplicitLinkedHashLRUCache(2);
    ...
    void testCacheEvictionOrder() {
        ExplicitLinkedHashLRUCache cache = new ExplicitLinkedHashLRUCache(3);
    ...
    void testEdgeCases() {
        // 测试容量为 1 的缓存
        ExplicitLinkedHashLRUCache cache = new ExplicitLinkedHashLRUCache(1);
        ...
        // 测试容量为 0 的缓存
        ExplicitLinkedHashLRUCache emptyCache = new ExplicitLinkedHashLRUCache(0);
        emptyCache.put(1, 1);
